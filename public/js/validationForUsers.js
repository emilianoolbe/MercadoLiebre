    ...
    switch (e.target.name) {
        ...
        case 'img':
            ...
            if (extesions.includes(fileExtension)) {
                document.getElementById('img').classList.add('inputBorderCorrect');
                document.getElementById('img').classList.remove('inputBorder');
                e.target.nextElementSibling.classList.remove('erroresFront');
                ...
                e.target.nextElementSibling.classList.add('erroresFront');
                e.target.nextElementSibling.innerText = 'Debe agregar una imagen, (*) Las extensiones de imagenes permitidas son: .jpg  .png .gif';
                fields['img'] = false;
            };    
            break;
        case 'password':
